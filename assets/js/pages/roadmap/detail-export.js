...
(function () {
  ...
  function toKpiItem(item, ctx) {
    ...
    return H.clean({
      ...
      business_benefit: item.business_benefit || null,
      benefit_type: item.benefit_type || null,
      benefit_status: item.benefit_status || null,
      pxp_staff_value: item.pxp_staff_value || null,
      partner_staff_value: item.partner_staff_value || null,
      merchant_value: item.merchant_value || null,
      sales_route: item.sales_route || null,
