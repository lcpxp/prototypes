...
| `App.platformCards` | assets/js/pages/platform/cards.js:201 |
| `App.platformKnowledge` | assets/js/pages/platform/knowledge.js:240 |
| `App.platformViews` | assets/js/pages/platform/views.js:314 |
...
| `App.roadmapDetailValues` | assets/js/pages/roadmap/detail-values.js:172 |
...
| `App.roadmapSprintCards` | assets/js/pages/roadmap/views-sprint-cards.js:176 |
...
| ui.js | 390 | ui.js - Shared UI: top navigation, HTML escaping, badges, copy, downloads and the guarded localStorage helper (App.store). |
...
| platform/cards.js | 212 | platform/cards.js - One capability, as a card (App.platformCards). |
| platform/knowledge.js | 250 | platform/knowledge.js - The parts of the platform knowledge base the capability catalogue alone cannot show (App.platformKnowledge). |
| platform/platform.js | 312 | platform/platform.js - The shell of the platform knowledge page: what it fetches, which view is showing, and the filter and disclosure wiring over it. |
| platform/views.js | 330 | platform/views.js - The three top-level views of the platform page (App.platformViews), the sidebar index and the filter toolbar. |
...
| roadmap/detail.js | 563 | roadmap/detail.js - Pure builders for the roadmap item drawer and the AI-optimised JSON export (App.roadmapDetail). |
...
| roadmap/views-sprint-cards.js | 184 | roadmap/views-sprint-cards.js - What each workstream buys, as the cards that sit below the sprint board. |
| roadmap/views-sprint.js | 483 | roadmap/views-sprint.js - The Sprint Roadmap: the same Now work the product board bands by horizon, placed instead against sprints. |
...
| sprints/sprints.js | 314 | sprints/sprints.js - The Sprint Roadmap page shell. |
...
| components.css | 587 | components.css - Reusable interface components: cards, forms, buttons, notices, tables, badges and toggles. |
...
| layout.css | 409 | layout.css - Navigation, page scaffold and grids. |
| login.css | 70 | login.css - Sign-in page only. |
| pages.css | 227 | pages.css - The reference viewer ("swagger") page. |
| platform.css | 283 | platform.css - The platform knowledge page (modules/platform/). |
...
| sprint-cards.css | 238 | sprint-cards.css - What each workstream buys, as the cards below the sprint board. |
| sprints.css | 455 | sprints.css - The Sprint Roadmap BOARD, and only that. |
...
| platform/index.html | 59 | Platform - LPIO |
...
| sprints/index.html | 99 | Sprint roadmap - LPIO |
...
| 20260907180228_platform_knowledge_axes.sql | 93 | ---------------------------------------------------------------- Applied 2026-09-07. |
| 20260907180300_platform_as_of_from_created.sql | 24 | ---------------------------------------------------------------- Applied 2026-09-07. |
| 20260907180336_platform_context_functions.sql | 14 | ---------------------------------------------------------------- Applied 2026-09-07. |
| 20260907184036_platform_gaps_delivered_only.sql | 19 | ---------------------------------------------------------------- Applied 2026-09-07. |
| 20260907193920_integration_estate_capabilities_and_notes.sql | 66 | ---------------------------------------------------------------- Applied 2026-09-07. |
| 20260907194119_fix_integration_estate_view_fanout.sql | 44 | ---------------------------------------------------------------- Applied 2026-09-07. |
| 20260907194138_integration_views_security_invoker.sql | 20 | ---------------------------------------------------------------- Applied 2026-09-07. |
| 20260915164810_sprints_calendar.sql | 35 | ---------------------------------------------------------------- Applied 2026-09-15. |
| 20260915164839_sprint_plan_and_allocation.sql | 122 | ---------------------------------------------------------------- Applied 2026-09-15. |
| 20260915164849_work_item_metrics.sql | 42 | ---------------------------------------------------------------- Applied 2026-09-15. |
| 20260915164908_sprint_tables_policies.sql | 37 | ---------------------------------------------------------------- Applied 2026-09-15. |
...
| 30_work.sql | 509 | ---------------------------------------------------------------- 30_work.sql - The working-record domain: shared area taxonomy, roadmap/backlog work items, intake and notes (see docs/WORKFLOW.md). |
...
| 35_sprints.sql | 380 | ---------------------------------------------------------------- 35_sprints.sql - The Sprint Roadmap: the sprint calendar, the plan anchor and the per-item allocation. |
...
| render-coverage.test.js | 406 | tests/checks/render-coverage.test.js - Nothing stored-but-invisible. |
...
| sprint-contract.test.js | 138 | tests/checks/sprint-contract.test.js - The Sprint Roadmap's view reads a set of column names. |
...
| blocks.test.js | 123 | tests/unit/blocks.test.js - The typed-block renderer. |
...
| platform/knowledge.test.js | 187 | tests/unit/platform/knowledge.test.js - The stores the capability catalogue could not show. |
| platform/render.test.js | 191 | tests/unit/platform/render.test.js - Benchmarks for one capability as a card (App.platformCards in assets/js/pages/platform/cards.js). |
| platform/views.test.js | 216 | tests/unit/platform/views.test.js - The three top-level views (App.platformViews in assets/js/pages/platform/views.js). |
...
| roadmap/detail.test.js | 520 | tests/unit/roadmap/detail.test.js - Benchmarks for the item detail drawer (App.roadmapDetail.drawerHtml). |
...
| roadmap/views-sprint-cards.test.js | 188 | tests/unit/roadmap/views-sprint-cards.test.js - Benchmarks for the workstream cards below the Sprint Roadmap (App.roadmapSprintCards), rendered into both boards by sprintStreams and sprintItems alike. |
| roadmap/views-sprint.test.js | 332 | tests/unit/roadmap/views-sprint.test.js - Benchmarks for the Sprint Roadmap BOARD (App.roadmapView.sprintStreams / sprintItems): the axis, the spans, the external marking and hide mode. |
...
| size-budget.json | 114 | Line budgets per file type, enforced by tests/checks/size.test.js. soft = a warning that a split is due; hard = a failure, split before extending. Line count is only a PROXY for what actually degrades a reader, which is one concept stated in two places saying slightly different things - and that is enforced directly by the one-home gate. Where the two disagree, the one-home gate wins: a longer single file beats the same rule restated in three shorter ones. |
| surface-baseline.json | 864 | Generated baseline read by tests/checks/surface.test.js. Regenerate DELIBERATELY with `npm run surface` when a surface or an include genuinely changes, and read the diff: the point of this file is that such a change is a reviewable line, not a silent side effect. |
...
| gen-knowledge.js | 237 | scripts/gen-knowledge.js - Generates supabase/knowledge-coverage.json, the repo's committed account of whether what the system was told is still anchored, sourced and reachable. |
...
| CHANGELOG.md | 619 | Changelog All notable user-facing changes to LPIO, newest first. |
...
| STATE.md | 40 | Current state Updated: 2026-09-17 (Sprint roadmap overhauled for the room it is read in) # In progress Nothing blocking. |
