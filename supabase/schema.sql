...
-- ---------------------------------------------------------------
-- Roadmap. Four tables designed so every future roadmap view
-- (timeline graphic, swimlanes, waterfall priority, zoomed detail,
-- exported snapshots) is a rendering of the same rows and all
-- day-to-day adjustment is a database edit:
--   roadmap_areas         development areas / swimlanes
